...
class Turno {
    ...
    private LinkedList<AcaoJogador> calculaOrdem() {
        ...
        LinkedList<AcaoJogador> ordem = new LinkedList<>();
    ...
    private AcaoJogador getAcaoJogador1() {
        return acaoJogador1;
    }
    ...
    private void setAcaoJogador1(AcaoJogador acaoJogador1) {
        Turno.acaoJogador1 = acaoJogador1;
    }

    private void setAcaoJogador2(AcaoJogador acaoJogador2) {
