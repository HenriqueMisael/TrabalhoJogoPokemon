...
public class Batalha {
    ...
    //ATRIBUTOS
    private final Jogador time1;
    private final Jogador time2;
    ...
    public void start() {
        ...
        while (vencedor == null) {
            ...
            switch (turno.carregado()) {
                case 0:
                    turno = new Turno(time1.escolherComando(time2), time2.escolherComando(time1));
                    break;
                case 1:
                    turno = new Turno(time2.escolherComando(time1));
                    break;
                case 2:
                    turno = new Turno(time1.escolherComando(time2));
                    break;
            }
